...
namespace com.IvanMurzak.Godot.MCP.PhantomCamera
{
    public partial class Tool_PhantomCamera
    {
        ...
        public const string EditorInfoToolId = "phantomcamera-editor-info";
        ...
        /// phantomcamera-editor-info</c>), NOT by the pure-managed unit tests — a plain xUnit host
        ...
        (
            EditorInfoToolId,
            Title = "PhantomCamera Tools / Editor Info",
            ReadOnlyHint = true,
            IdempotentHint = true,
            OpenWorldHint = false
        )]
        [Description("Sample editor-only tool for the PhantomCamera Tools extension. Returns the running " +
